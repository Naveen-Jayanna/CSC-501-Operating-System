...
LOCAL int sysinit()
{
	...
	*( (int *)pptr->pbase ) = MAGIC;
	...
	/*Initialize the variables required by linux-like scheduler to 0*/
	pptr->goodness = 0;			/* Initialize the goodness of the process to 0		*/
	pptr->quantum = 0;			/* Initialize the quantum of the process to 0		*/
	pptr->unused_quantum = 0; 	/* Initialize the unused quantum of the process to 0 */
