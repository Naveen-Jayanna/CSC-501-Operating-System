					...
					/* array in the code)		*/
{
	...
	/*Set the variables required by linux-like scheduler to 0*/
	pptr->goodness = 0;			/* Set the goodness of the process to 0		*/
	pptr->quantum = 0;			/* Set the quantum of the process to 0		*/
	pptr->unused_quantum = 0; 	/* Set the unused quantum of the process to 0 */
